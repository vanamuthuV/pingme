...
//         <header className="flex-shrink-0 flex py-2.5 items-center gap-2 border-b bg-background/80 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/60">
...
//         {/* <CHANGE> Removed py-1 px-10 padding and added overflow-hidden to prevent double scrollbars */}
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="flex flex-col h-screen">
        ...
        {/* Removed py-1 px-10 padding and added overflow-hidden to prevent double scrollbars */}
        <main className="flex flex-col items-center justify-center flex-1 overflow-hidden">{children}</main>
