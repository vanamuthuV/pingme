    ...
    <div className="min-h-screen bg-white overflow-hidden relative">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-6 md:px-12">
        ...
        <Button
          ...
          className="bg-gray-900 hover:bg-gray-800 text-white px-6 py-2 rounded-full font-medium shadow-sm hover:shadow-md transition-all duration-300"
        >
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-md bg-white">
          ...
          <div className="flex flex-col items-center space-y-6 py-6">
            ...
            <Button
              className="w-full bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 shadow-sm font-medium py-3 px-4 rounded-lg transition-colors duration-200"
              onClick={() => {
